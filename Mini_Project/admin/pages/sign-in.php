...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "SELECT Admin_ID, Password FROM admin WHERE Email_ID = ?";
    ...
    if ($row = $result->fetch_assoc()) {
        ...
        echo "<script>alert('Admin not found'); window.location.href='sign-in.php';</script>";
    }
    $stmt->close();
}
...
<body class="bg-gray-200">
  ...
  <main class="main-content  mt-0">
    ...
    <a href="forgot-password.php" class="text-primary text-gradient font-weight-bold">Forgot Password?</a>
</p>
