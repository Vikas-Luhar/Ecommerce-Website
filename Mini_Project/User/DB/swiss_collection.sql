...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 27, 2024 at 01:17 PM
...
(1, 'Marble', 'Marble is a metamorphic rock known for its smooth texture and beautiful, varied patterns. It forms from limestone under heat and pressure, with colors ranging from white to black, often with veins or swirls. Commonly used in sculpture, architecture, and interior design, marble is prized for its aesthetic appeal and durability.', './uploads/Marble 10 (3).avif', 1500, 1, '2024-08-27'),
(2, 'Tile', 'Tiles are flat, thin pieces of material used for covering surfaces like floors, walls, and countertops. They can be made from ceramics, stone, glass, or other materials and come in various sizes, colors, and patterns. Tiles are popular for their durability, ease of cleaning, and ability to enhance the aesthetic of a space.', './uploads/login-bg.jpg', 1000, 2, '2024-08-27');
